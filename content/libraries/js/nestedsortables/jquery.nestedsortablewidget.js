...
jQuery.NestedSortableWidget = {
	...
	loadData: function(e, page) {		
		...
		var itemsToRequest;
		if(typeof(e.nestedSortWidgetCfg.jsonData) !== 'undefined') {
			process(e.nestedSortWidgetCfg.jsonData);
		}
		else {
	...
	save: function() {
		...
		return this.each( function() {
			if(this.isNestedSortableWidget) {
				...
				if(typeof(this.nestedSortWidgetCfg.doSave) != "undefined") {
				    this.nestedSortWidgetCfg.doSave(this);
				}
				else {
